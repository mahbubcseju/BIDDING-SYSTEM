<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewMyItem.aspx.cs" Inherits="BidWeb.ViewMyItem" EnableEventValidation ="false"%>
    ...
    <form id="form1" runat="server">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color: white">Menu<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="ViewAllItem.aspx">View All Item</a></li>
        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <asp:GridView ID="ItemListGridView" runat="server" CssClass="table table-responsive table-hover" AutoGenerateColumns="False" OnRowDataBound="ItemListGridView_OnRowDataBound" OnSelectedIndexChanged="ItemListGridView_OnSelectedIndexChanged">
                    <Columns>
