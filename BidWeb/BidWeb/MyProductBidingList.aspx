<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyProductBidingList.aspx.cs" Inherits="BidWeb.MyProductBidingList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="jumbotron">
                <h2 style="text-align: center">My Product Biding List</h2>
                <asp:GridView ID="bidingListGridView" runat="server" CssClass="table table-responsive table-hover" AutoGenerateColumns="False">
                    <Columns>
                        <asp:BoundField DataField="UserName" HeaderText="Name" />
                        <asp:BoundField DataField="ProductCode" HeaderText="Code" />
                        <asp:BoundField DataField="MaxBid" HeaderText="Taka" />
                        <asp:BoundField DataField="DateHeBid" HeaderText="Date" />
                    </Columns>
                </asp:GridView>

                <asp:Button ID="soldButton" runat="server" Text="Sold" OnClick="soldButton_Click" CssClass="btn btn-danger"/>
            </div>
        </div>
    </form>
</body>
