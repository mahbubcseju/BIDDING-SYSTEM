<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyBoughtList.aspx.cs" Inherits="BidWeb.MyBoughtList1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="jumbotron">
                <h2 style="text-align: center">My Bought List</h2>
                <asp:GridView ID="myBoughtListGridView" runat="server" AutoGenerateColumns="False" CssClass="table">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Image">
                            <ItemTemplate>
                                <asp:Image ID="Image1" runat="server" Height="75px"
                                    ImageUrl='<%#Eval("Picture")%>' Width="75px" />
                                <br />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="BidMoney" HeaderText="Taka" />
