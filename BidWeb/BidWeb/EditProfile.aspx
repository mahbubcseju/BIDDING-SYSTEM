<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs" Inherits="BidWeb.EditProfile" %>
                        ...
                        <div class="col-md-4">
                            <div class="form-horizontal col-xs-5">
                                <div class="form-group">
                                    <asp:Label ID="Label2" runat="server" Text="New Password" CssClass="control-label col-md-2"></asp:Label>
                                    <div class="col-md-10">
                                ...
                                <asp:Button ID="updateButton" runat="server" OnClick="updateButton_OnClick" Text="Save" CssClass="btn btn-success" />
                            </div>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
